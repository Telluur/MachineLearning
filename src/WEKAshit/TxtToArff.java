...
public class TxtToArff {
	...
	final public static String trainPath = BASE_LOC + "\\train";
	final public static String testPath = BASE_LOC + "\\test";
	final static public String result = BASE_LOC + "\\spammail\\result.arff";
	...
	public static void main(String[] args) {
		Instances train = buildARFF(new File(trainPath));
		Instances test = buildARFF(new File(testPath));
	...
	private static void cascadeBuildARFF(Instances dataRaw, final File folder) {
		for (final File fileEntry : folder.listFiles()) {
			if (fileEntry.isDirectory()) {
				...
				if (fileEntry.getName().contains("F-train")) {
					addFileAsContent(fileEntry, dataRaw, true);
				} else if (fileEntry.getName().contains("M-train")) {
