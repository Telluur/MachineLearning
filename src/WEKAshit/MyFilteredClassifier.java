 ...
 */
 public class MyFilteredClassifier {
	...
	public void makeInstance() {
		...
		instances = new Instances("Test relation", fvWekaAttributes, 3);           
		// Set class index
	...
	public static void main (String[] args) {
		final String BASE_LOC = System.getProperty("user.dir");
		final String trainPath = BASE_LOC + "\\blogs_train_generated.arff";
		final  String testPath = BASE_LOC + "\\blogs_test_generated.arff";
		final  String result = BASE_LOC + "\\spammail\\result2.txt";
...
//		else {
			...
			classifier.load(testPath);
			classifier.loadModel(result);
			classifier.makeInstance();
			System.out.println("blaat FTW ");
			classifier.classify();
//		}
	}
}	